        ...
        for key in key_set:
            ...
            if field_key:
                try:
                    ...
                    if key == 'chi':
                        array = self.problem.parameters['chi_l']['g'][0,0,:] +\
                                self.problem.parameters['chi_r']['g'][0,0,:]
                    elif key == 'nu':
                        array = self.problem.parameters['nu_l']['g'][0,0,:] +\
                                self.problem.parameters['nu_r']['g'][0,0,:]
                    elif key == 'del_chi':
                        array = self.problem.parameters['del_chi_l']['g'][0,0,:] +\
                                self.problem.parameters['del_chi_r']['g'][0,0,:]
                    elif key == 'del_nu':
                        array = self.problem.parameters['del_nu_l']['g'][0,0,:] +\
