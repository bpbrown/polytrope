...
analysis_scalar.add_task("integ(sqrt(u**2), 'x')/Lx", name="u_rms")
analysis_scalar.add_task("integ(sqrt(w**2), 'x')/Lx", name="w_rms")
analysis_scalar.add_task("integ(sqrt(u**2+w**2)*Lz/nu, 'x')/Lx", name="Re_rms")
analysis_scalar.add_task("integ(sqrt(u**2+w**2)*Lz/chi, 'x')/Lx", name="Pe_rms")
