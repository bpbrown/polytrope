...
def AN_convection(Rayleigh=1e6, Prandtl=1, n_rho_cz=3.5, restart=None, nz=128, data_dir='./'):
    import numpy as np
    import time
    import equations
    import os
    ...
    atmosphere = equations.AN_polytrope(nx=nx, nz=nz, n_rho_cz=n_rho_cz)
...
if __name__ == "__main__":
    ...
    AN_convection(Rayleigh=float(args['--Rayleigh']),
